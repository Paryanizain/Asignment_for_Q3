const Related = () => {
    return (
        <div className="ms-[550px]">
      <div className="border-t-1 border-slate-300 place-content-center w-[960px] h-[259px]">
        <h1 className="text-[19px] py-5">
        Related Categories
        </h1>
        <div className="space-x-2 space-y-2">
            <button className="border rounded-xl text-xs p-[8px] px-[15px]">Best Selling Products</button>
